(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../geometry", "../utils/hachure"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const geometry_1 = require("../geometry");
    const hachure_1 = require("../utils/hachure");
    ...
    function getIntersectingLines(line, points) {
        const intersections = [];
        const s1 = new geometry_1.Segment([line[0], line[1]], [line[2], line[3]]);
        for (let i = 0; i < points.length; i++) {
            const s2 = new geometry_1.Segment(points[i], points[(i + 1) % points.length]);
            if (s1.intersects(s2)) {
