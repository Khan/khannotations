...
export declare function hachureLinesForEllipse(helper: RenderHelper, cx: number, cy: number, width: number, height: number, o: ResolvedOptions): Line[];
//# sourceMappingURL=filler-utils.d.ts.map